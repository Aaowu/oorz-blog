...
export default function NavCard() {
	...
	const avatarSrc = `/images/avatar.png?v=${siteContent.assetVersion || 1}`
			...
			<HomeDraggableLayer cardKey='navCard' x={position.x} y={position.y} width={styles.width} height={styles.height}>
				<Card
					...
					<Link className='flex items-center gap-3' href='/'>
						<img src={avatarSrc} alt='avatar' width={40} height={40} style={{ boxShadow: ' 0 12px 20px -5px #E2D9CE' }} className='rounded-full object-cover' />
